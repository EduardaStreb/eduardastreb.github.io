    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, hsl(318 100% 70% / 0.08) 0%, transparent 40%, hsl(0 0% 4%) 100%)",
          }}
        />
      </div>
      ...
      >
        ...
        <div className="absolute inset-0" style={{ background: "linear-gradient(to top, hsl(0 0% 4% / 0.6), transparent)" }} />
      </div>
    </section>
  );
};
